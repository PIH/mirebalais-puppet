...
update person_name pn inner join person p on pn.person_id = p.person_id set pn.given_name = 'Mary' where p.gender = 'F' and p.person_id % 2 = 0;
update person_name pn inner join person p on pn.person_id = p.person_id set pn.given_name = 'Ophelia' where p.gender = 'F' and p.person_id % 3 = 0;
update person_name pn inner join person p on pn.person_id = p.person_id set pn.given_name = 'Kathryn' where p.gender = 'F' and p.person_id % 4 = 0;
update person_name pn inner join person p on pn.person_id = p.person_id set pn.given_name = 'Ellen' where p.gender = 'F' and p.person_id % 5 = 0;
update person_name pn inner join person p on pn.person_id = p.person_id set pn.given_name = 'Naomi' where p.gender = 'F' and p.person_id % 6 = 0;
update person_name pn inner join person p on pn.person_id = p.person_id set pn.given_name = 'Claire' where p.gender = 'F' and p.person_id % 7 = 0;
update person_name pn inner join person p on pn.person_id = p.person_id set pn.given_name = 'Lucy' where p.gender = 'F' and p.person_id % 8 = 0;
update person_name pn inner join person p on pn.person_id = p.person_id set pn.given_name = 'Carole' where p.gender = 'F' and p.person_id % 9 = 0;
update person_name pn inner join person p on pn.person_id = p.person_id set pn.given_name = 'Sophia' where p.gender = 'F' and p.person_id % 10 = 0;
update person_name pn inner join person p on pn.person_id = p.person_id set pn.given_name = 'Alice' where p.gender = 'F' and p.person_id % 11 = 0;
update person_name pn inner join person p on pn.person_id = p.person_id set pn.given_name = 'Melissa' where p.gender = 'F' and p.person_id % 12 = 0;
update person_name pn inner join person p on pn.person_id = p.person_id set pn.given_name = 'Vanessa' where p.gender = 'F' and p.person_id % 13 = 0;
update person_name pn inner join person p on pn.person_id = p.person_id set pn.given_name = 'Sally' where p.gender = 'F' and p.person_id % 14 = 0;
update person_name pn inner join person p on pn.person_id = p.person_id set pn.given_name = 'Anne' where p.gender = 'F' and p.person_id % 15 = 0;
update person_name pn inner join person p on pn.person_id = p.person_id set pn.given_name = 'Katie' where p.gender = 'F' and p.person_id % 16 = 0;
update person_name pn inner join person p on pn.person_id = p.person_id set pn.given_name = 'Jennifer' where p.gender = 'F' and p.person_id % 17 = 0;
update person_name pn inner join person p on pn.person_id = p.person_id set pn.given_name = 'Jill' where p.gender = 'F' and p.person_id % 18 = 0;
update person_name pn inner join person p on pn.person_id = p.person_id set pn.given_name = 'Susan' where p.gender = 'F' and p.person_id % 19 = 0;
update person_name pn inner join person p on pn.person_id = p.person_id set pn.given_name = 'Megan' where p.gender = 'F' and p.person_id % 20 = 0;
update person_name pn inner join person p on pn.person_id = p.person_id set pn.given_name = 'Amanda' where p.gender = 'F' and p.person_id % 21 = 0;
